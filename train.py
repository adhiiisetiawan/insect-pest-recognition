...
wandb.init(project='large-scale-pest-recognition', name="MobileNetV3-small_cutmix_dlr", reinit=True)
...
}, "/home/adhi/output-model/checkpoint1-mobilenetv3-small_cutmix.pth")
...
torch.save(model.state_dict(), "/home/adhi/output-model/mobilenetv3s_cutmix_dlr.pth")